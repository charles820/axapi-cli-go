...
func (i *Ipv4) Help() string {
	return `
$ ... slb.session.ipv4 <subcommand>

To see options for each <subcommand>, try
$ ... slb.session.ipv4 <subdommand> --help

Available Subcommands:
	get    : "slb.session.ipv4.get method."
	`
}

func (i *Ipv4) Synopsis() string {
	return "slb.session.ipv4 method."
}

func (i *Ipv4) Run(args []string) int {
	if len(args) == 0 {
		fmt.Println(i.Help())
		os.Exit(0)
	}
...
/**
 * AXAPI(2.1) Method: Slb.Session.Ipv4.Get
 */

func (i *Ipv4) Get(args []string) (string, error) {
	// options
	var opts struct {
		GlobalFlags
