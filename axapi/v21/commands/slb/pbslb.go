...
func (p *Pbslb) Help() string {
	return `
$ ... slb.pbslb <subcommand>

To see options for each <subcommand>, try
$ ... slb.pbslb <subdommand> --help

Available Subcommands:
	getAll             : "slb.pbslb.getAll method."
	search             : "slb.pbslb.search method."
	`
}

func (p *Pbslb) Synopsis() string {
	return "slb.pbslb method."
}
...
/**
 * AXAPI(2.1) Method: Slb.Pbslb.GetAll
 */
...
/**
 * AXAPI(2.1) Method: Slb.Pbslb.Search
 */
...
func (p *Pbslb) Search(args []string) (string, error) {
	...
	var opts struct {
		GlobalFlags
		Name string `long:"name" description:"name of real pbslb"`
	}
