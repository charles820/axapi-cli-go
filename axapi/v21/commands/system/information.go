...
$ ... system.information <subdommand> --help

Available Subcommands:
	get : system.information.get method.
	`
}

func (i *Information) Synopsis() string {
	return "system.information method."
}
...
/**
 * AXAPI(2.1) Method: AXAPI Method: System.Information.Get
 */

func (i *Information) Get(args []string) (string, error) {
	// options
